...
label realWorld:
    ...
    "接著是一陣暈眩，我眼前的白在不停地閃爍，刺激的我幾乎睜不開眼，整個人好像是被不停搖晃一般。"
...
label cont:
    if cnt == 2:
        # 只有撞兩次才會破，太多太少都不行
        # 屏障自己突然打開了，進去看到解救世界的線索/方法
        # 主角在時間斷崖中摸索出拯救世界的方法，最終成功拯救了世界。
        jump end3_0
    else:
        # 牆沒破，覺得很不爽
        # 主角知曉了自己不過是被創造出來的一個虛擬人物，沒辦法接受這個事實的主角最後和出太多bug的世界一起毀滅了。
        jump end4_0